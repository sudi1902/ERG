...
const GW_CONFIG = {
  ...
  datasets: {
    ...
    zoning: {
      ...
      fields: {
        date:    ["status_date", "filed_date", "application_date", "created_date", "case_filed_date", "last_update"],
        applied: ["application_start_date", "filed_date"],
        number:  ["case_number", "zoning_case_number", "case_num", "case"],
        name:    ["case_name", "project_name", "name"],
        desc:    ["description_of_work", "request", "description", "case_description"],
        caseType:["sub_type", "case_type", "work_type"],
        status:  ["detailed_status", "status", "case_status", "status_description"],
    ...
    co: {
      ...
      fields: {
        ...
        use:     ["description", "existing_use", "proposed_use", "use_category", "primary_use"],
        desc:    ["description", "project_name", "business_name"],
        valuation: ["total_job_valuation", "building_valuation"],
    ...
    council: {
      ...
      fields: {
        date:   ["agenda_date", "meeting_date", "council_meeting_date", "date"],
        title:  ["posting_language", "title", "agenda_item", "item_text", "caption", "recommendation", "description"],
        item:   ["item_number", "agenda_item_number", "item"],
        itemType:["request_type", "item_type"],
        dept:   ["lead_dept", "department", "dept", "sponsoring_department"],
        sponsor:["sponsor"],
        status: ["status", "item_status", "action"],
        district:["district", "districts_impacted", "council_district"],
        caseNo: ["request_number", "zoning_case_number", "case_number"],
        link:   ["attachments", "link", "url", "backup_link"],
      },
    },
  },
