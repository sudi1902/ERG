...
| **Map explorer** | A Leaflet map of Austin with four live layers — commercial building permits, trade permits (electrical / plumbing / mechanical), zoning cases, and commercial certificates of occupancy — all scoped by a shared **activity window** (30 days / 3 / 6 / 12 months). **Click anywhere** to drop a ¼ / ½ / 1-mile survey circle and get an instant area report of everything inside it for the chosen window |
